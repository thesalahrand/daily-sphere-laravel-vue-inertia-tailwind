        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start">
            ...
            <Link href="/" class="flex items-center space-x-2">
              <ApplicationLogo
                class="w-8 h-8 fill-current text-gray-900 dark:text-white"
              />
          ...
          <div class="flex items-center">
            <div class="flex items-center ml-3">
              ...
              <div
                class="w-32 z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                id="dropdown-user"
              >
        ...
        <ul class="space-y-2 font-medium">
          <li>
            ...
            >
              <img
                class="w-6 h-6"
                src="/images/prayer-tracker.png"
                alt="prayer-tracker"
              />
              <span class="ml-3">Prayer Tracker</span>
            </a>
          </li>
          <li>
            <a
            ...
            >
              <img
                class="w-6 h-6"
                src="/images/fasting-tracker.png"
                alt="fasting-tracker"
              />
              <span class="ml-3">Fasting Tracker</span>
            </a>
          </li>
          <li>
            <a
